...
output_dir = Path(r"C:\Users\anaba\OneDrive\Ambiente de Trabalho\Investigação\4. Factory Lab\1. Games and dynamics\
                    1. Ordens de Produção - Ronda 1 e 2\1. QR_codes\QR_codes_png")
